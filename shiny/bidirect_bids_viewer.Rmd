...
shinyApp(
  ui = fillPage(
    ...
    #    h6("   "),
        ...
        h6("Debug: Cannot open the connection - This means, that a file is missing! Check in the data overview your selection of parameters")
      ),
   # fillCol(
      papayaOutput("papayaViewer", width = "100%")
      #textOutput("text"),
